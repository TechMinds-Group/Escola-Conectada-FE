...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'consulta-matriz-escolar', component: ConsultaMatrizEscolarPage },
      { path: 'cadastro-matriz-escolar', component: CadastroMatrizEscolarPage },
      { path: 'cadastro-matriz-escolar/:id', component: CadastroMatrizEscolarPage },
