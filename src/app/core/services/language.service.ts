...
export class LanguageService {
  ...
  private dictionary: TranslationDictionary = {
    ...
    SUBJECT: { 'PT-BR': 'Matéria', ES: 'Asignatura' },
    ...
    SELECT_SUBJECT: { 'PT-BR': 'Selecione uma matéria.', ES: 'Seleccione una asignatura.' },
    SUBJECT_REQUIRED: { 'PT-BR': 'Matéria obrigatória.', ES: 'Asignatura obligatoria.' },
    SELECT_PLACEHOLDER: { 'PT-BR': 'Selecione...', ES: 'Seleccione...' },
    SUBJECTS_AND_WORKLOAD: {
      'PT-BR': 'Matérias e Carga Horária (semanal)',
